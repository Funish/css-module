<template>
  <div>
    <h1>Position</h1>
    <hr />
    <div class="fu-border fu-border-fade fu-width-1-1 fu-height-xlarge fu-position-relative">
      ...
      <div class="fu-position-bottom-right">.fu-position-bottom-right</div>
      <div class="fu-position-bottom-center">.fu-position-bottom-center</div>
      <div class="fu-position-center-left">.fu-position-center-left</div>
      <div class="fu-position-center-right">.fu-position-center-right</div>
